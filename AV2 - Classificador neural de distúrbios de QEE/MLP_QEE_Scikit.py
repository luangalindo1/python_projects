...
nomes_das_classes = ["Interrupção", "Elevação", "Afundamento", "Distorção"]

plt.plot(entradas.iloc[0, :])
...
#Alvo_tre_df = pd.DataFrame(Alvo_tre, columns = nomes_das_classes)
#Alvo_tre_df.groupby(["Afundamento"])


# Cria o modelo neural (uma camada oculta com 4 neurônios)
net = MLPClassifier(solver='lbfgs', max_iter=500, hidden_layer_sizes=(8), verbose=True, 
